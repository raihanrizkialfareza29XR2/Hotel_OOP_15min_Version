...
public class VIP extends Reguler{
    Scanner input = new Scanner(System.in);

    public void setInfo(String nama, String KTP, String swab){
        System.out.println("");
        System.out.println("|--Anda Memilih Kamar Tipe VIP (harga Rp 450.000)--|"); // diganti
        this.nama = nama;
        this.KTP = KTP;
        this.swab = swab;
    }
    ...
    public void setTotal(){
        total = jumlah*450000; // diganti
        pajak = total*(0.10);
        results = total+pajak;
    }
    public double getTotal(){
        System.out.println("");
        System.out.println("|Total Tagihan : " + jumlah + " x Rp 450.000"); // diganti
