...
public class Suites extends Reguler {
    Scanner input = new Scanner(System.in);

    public void setInfo(String nama, String KTP, String swab){
        System.out.println("");
        System.out.println("|--Anda Memilih Kamar Tipe Suites (harga Rp 650.000)--|"); // diganti
        this.nama = nama;
        this.KTP = KTP;
        this.swab = swab;
    }
    ...
    public void setTotal(){
        total = jumlah*650000; // diganti
        pajak = total*(0.10);
        results = total+pajak;
    }
    public double getTotal(){
        System.out.println("");
        System.out.println("|Total Tagihan : " + jumlah + " x Rp 650.000"); // diganti
